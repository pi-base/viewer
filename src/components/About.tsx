...
const About = () => (
  <div className="container">
    <h2>Contributing</h2>
    <p>
      The <strong>pi-Base</strong> is a reflection of the results in general
      topology that have been published in peer-reviewed journals and
    ...
    <p>
      ...
      characterizations of topological properties. Several of
      his projects involve novel applications of technology to mathematical
      education and research, including the pi-Base and{' '}
      <a href="https://github.com/StevenClontz/sbg-rails">sbg-rails</a>.
      Email:{' '}
