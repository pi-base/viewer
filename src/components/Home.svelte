...
<div class="wide home-jumbotron jumbotron">
  <div class="container">
    <h1>π-Base</h1>
...
<p>
  ...
  properties, and theorems. More information may be found on our <a
    href={paths.contributingGuide()}>Contributing</a
  > page.
</p>
<p>
  π-Base’s <a href="https://github.com/pi-base/data">data</a> and
  <a href="https://github.com/pi-base/viewer">source code</a> are available on GitHub.
  Code contributions are welcomed as well!
</p>
<h2>About Us</h2>
<p>
  The π-Base was founded in 2014 by <a href="https://github.com/jamesdabbs"
    >James Dabbs</a
  >, who continues to maintain the project and serve as its main developer.
</p>
<p>
  <a href="https://github.com/stevenclontz">Steven Clontz</a> joined the project
  in 2017, serving as its lead mathematical editor.
</p>
...
<ul>
  ...
  <li>
    Our graduate advisor, <a href="http://www.auburn.edu/~gruengf/"
      >Gary Gruenhage</a
    >
    for all his support and guidance
  </li>
  <li>
    <a href="http://austinmohr.com/home/">Austin Mohr</a> for his work using the
    π-Base as a pedagogical tool, and all his invaluable feedback
  </li>
  <li>
  ...
  <li>
    Steen and Seebach for writing <a
