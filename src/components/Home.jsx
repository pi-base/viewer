...
const Home = () => (
  <div className="container">
    ...
    <ul>
      ...
      <li><a href="http://www.montevallo.edu/staff-bio/scott-varagona/">Scott Varagona</a> for his heroic work entering data into the database</li>
      <li>My advisor, <a href="http://www.auburn.edu/~gruengf/">Gary Gruenhage</a> for all his support and guidance</li>
      <li><a href="http://austinmohr.com/home/">Austin Mohr</a> for his work using the 𝜋-Base as a pedagogical tool, and all his invaluable feedback</li>
      <li>Steen and Seebach for writing <a href="http://www.amazon.com/Counterexamples-Topology-Dover-Books-Mathematics/dp/048668735X">Counterexamples in Topology</a> in the first place and inspiring this project</li>
    </ul>
  </div>
)
